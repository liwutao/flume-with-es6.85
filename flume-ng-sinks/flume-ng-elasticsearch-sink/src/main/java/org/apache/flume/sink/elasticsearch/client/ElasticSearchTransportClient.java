...
public class ElasticSearchTransportClient implements ElasticSearchClient {
  ...
  public ElasticSearchTransportClient(String[] hostNames, String clusterName,
      ElasticSearchEventSerializer serializer) throws ElasticSearchClientFailedException {
  ...
  public ElasticSearchTransportClient(String[] hostNames, String clusterName,
      ElasticSearchIndexRequestBuilderFactory indexBuilder) throws ElasticSearchClientFailedException {
    configureHostnames(hostNames);
  ...
  private void configureHostnames(String[] hostNames) throws ElasticSearchClientFailedException {
    ...
    try {
      ...
      String errMsg = "Fail to resolve hosts:" + host;
      logger.error(errMsg);
      throw new ElasticSearchClientFailedException(errMsg, e);
    }
  }
  ...
  public void addEvent(Event event, IndexNameBuilder indexNameBuilder,
    ...
    if (ttlMs > 0) {
      indexRequestBuilder.setTimeout(ttlMs/1000+"s");
    }
